...
$$ I(x, x'; \alpha) = g\left(/docs/notes/sml/(1-\alpha) f\left(/docs/notes/sml/x\right) + \alpha f(x')\right)$$
$$ I(x, /docs/notes/sml/x'; \alpha) = g\left(/docs/notes/sml/(1-\alpha) f\left(x\right) + \alpha f(/docs/notes/sml/x')\right)$$
$$ I(/docs/notes/sml/x, x'; \alpha) = g\left((1-\alpha) f\left(/docs/notes/sml/x\right) + \alpha f(x')\right)$$
$$ I(x, x'; \alpha) = g\left(/docs/notes/sml/(1-\alpha) f\left(/docs/notes/sml/x\right) + \alpha f(x')\right)$$
$$ I(x, /docs/notes/sml/x'; \alpha) = g\left((1-\alpha) f\left(/docs/notes/sml/x\right) + \alpha f(/docs/notes/sml/x')\right)$$
