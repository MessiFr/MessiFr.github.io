...
$$ I(/docs/notes/sml/x, x'; \alpha) = g\left(/docs/notes/sml/(1-\alpha) f\left(x\right) + \alpha f(x')\right)$$
$$ I(/docs/notes/sml/x, x'; \alpha) = g\left(/docs/notes/sml/(1-\alpha) f\left(/docs/notes/sml/x\right) + \alpha f(x')\right)$$
$$ I(/docs/notes/sml/x, /docs/notes/sml/x'; \alpha) = g\left(/docs/notes/sml/(1-\alpha) f\left(/docs/notes/sml/x\right) + \alpha f(/docs/notes/sml/x')\right)$$
$$ I(/docs/notes/sml/x, /docs/notes/sml/x'; \alpha) = g\left(/docs/notes/sml/(1-\alpha) f\left(x\right) + \alpha f(/docs/notes/sml/x')\right)$$
$$ I(/docs/notes/sml/x, /docs/notes/sml/x'; \alpha) = g\left(/docs/notes/sml/(1-\alpha) f\left(/docs/notes/sml/x\right) + \alpha f(/docs/notes/sml/x')\right)$$
$$ I(/docs/notes/sml/x, x'; \alpha) = g\left((1-\alpha) f\left(/docs/notes/sml/x\right) + \alpha f(x')\right)$$
$$ I(/docs/notes/sml/x, x'; \alpha) = g\left(/docs/notes/sml/(1-\alpha) f\left(/docs/notes/sml/x\right) + \alpha f(x')\right)$$
$$ I(/docs/notes/sml/x, /docs/notes/sml/x'; \alpha) = g\left(/docs/notes/sml/(1-\alpha) f\left(/docs/notes/sml/x\right) + \alpha f(/docs/notes/sml/x')\right)$$
$$ I(/docs/notes/sml/x, /docs/notes/sml/x'; \alpha) = g\left((1-\alpha) f\left(/docs/notes/sml/x\right) + \alpha f(/docs/notes/sml/x')\right)$$
$$ I(/docs/notes/sml/x, /docs/notes/sml/x'; \alpha) = g\left(/docs/notes/sml/(1-\alpha) f\left(/docs/notes/sml/x\right) + \alpha f(/docs/notes/sml/x')\right)$$
$$ I(/docs/notes/sml/x, /docs/notes/sml/x'; \alpha) = g\left((1-\alpha) f\left(x\right) + \alpha f(/docs/notes/sml/x')\right)$$
$$ I(/docs/notes/sml/x, /docs/notes/sml/x'; \alpha) = g\left(/docs/notes/sml/(1-\alpha) f\left(x\right) + \alpha f(/docs/notes/sml/x')\right)$$
$$ I(/docs/notes/sml/x, /docs/notes/sml/x'; \alpha) = g\left(/docs/notes/sml/(1-\alpha) f\left(/docs/notes/sml/x\right) + \alpha f(/docs/notes/sml/x')\right)$$
$$ I(/docs/notes/sml/x, /docs/notes/sml/x'; \alpha) = g\left((1-\alpha) f\left(/docs/notes/sml/x\right) + \alpha f(/docs/notes/sml/x')\right)$$
$$ I(/docs/notes/sml/x, /docs/notes/sml/x'; \alpha) = g\left(/docs/notes/sml/(1-\alpha) f\left(/docs/notes/sml/x\right) + \alpha f(/docs/notes/sml/x')\right)$$
...
x_i, x_f = torch.unsqueeze(/docs/notes/sml/images[0], dim=0), torch.unsqueeze(/docs/notes/sml/images[3], dim=0)
